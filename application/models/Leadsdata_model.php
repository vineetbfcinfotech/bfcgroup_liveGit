...
if (is_admin() || is_headtrm()) {
	$this->db->select('*');
		...
		//  $query2 = $this->db->query("SELECT * FROM `tblstaff` JOIN `tblleads` ON `tblleads`.`assigned` = `tblstaff`.`staffid` WHERE `tblstaff`.`pre_pm_assign_to` = '".$pm_id."' AND `tblleads`.`status` = '3' AND tblleads.lead_booking_amount_date < tblstaff.pm_assign_date;")->result();
		 ...
		 $query3 = $this->db->query("SELECT `tblleads_create_package`.*,`tblstaff`.`firstname`,`tblstaff`.`lastname`,`tblleads`.`email`,`tblleads`.`phonenumber` FROM `tblstaff` JOIN `tblleads_create_package` ON `tblleads_create_package`.`assigned` = `tblstaff`.`staffid` JOIN `tblleads` ON `tblleads`.`id` = `tblleads_create_package`.`leadid` WHERE `tblstaff`.`pm_assign_to` = '".$pm_id."' AND `tblleads_create_package`.`pm_project_status` = '3' AND DATE_FORMAT(tblleads_create_package.lead_booking_amount_date,'%Y-%m-%d') >= DATE_FORMAT(tblstaff.pm_assign_date,'%Y-%m-%d') ORDER BY `tblleads_create_package`.`lead_booking_amount_date` DESC;")->result();
...
if (is_admin() || is_headtrm()) {
	$this->db->select('*');
		...
		//   echo $this->db->last_query();	
		 ...
		 $query3 = $this->db->query("SELECT `tblleads_create_package`.*,`tblstaff`.`firstname`,`tblstaff`.`lastname`,`tblleads`.`email`,`tblleads`.`phonenumber` FROM `tblstaff` JOIN `tblleads_create_package` ON `tblleads_create_package`.`assigned` = `tblstaff`.`staffid` JOIN `tblleads` ON `tblleads`.`id` = `tblleads_create_package`.`leadid` WHERE `tblstaff`.`pm_assign_to` = '".$pm_id."' AND `tblleads_create_package`.`pm_project_status` = '1' AND DATE_FORMAT(tblleads_create_package.lead_booking_amount_date,'%Y-%m-%d') >= DATE_FORMAT(tblstaff.pm_assign_date,'%Y-%m-%d') ORDER BY `tblleads_create_package`.`lead_booking_amount_date` DESC;")->result();
...
if (is_admin() || is_headtrm()) {
		...
		$query3 = $this->db->query("SELECT `tblleads_create_package`.*,`tblstaff`.`firstname`,`tblstaff`.`lastname`,`tblleads`.`email`,`tblleads`.`phonenumber` FROM `tblstaff` JOIN `tblleads_create_package` ON `tblleads_create_package`.`assigned` = `tblstaff`.`staffid` JOIN `tblleads` ON `tblleads`.`id` = `tblleads_create_package`.`leadid` WHERE `tblstaff`.`pm_assign_to` = '".$pm_id."' AND `tblleads_create_package`.`pm_project_status` = '2' AND DATE_FORMAT(tblleads_create_package.lead_booking_amount_date,'%Y-%m-%d') >= DATE_FORMAT(tblstaff.pm_assign_date,'%Y-%m-%d') ORDER BY `tblleads_create_package`.`lead_pm_takeup_date` DESC;")->result();
