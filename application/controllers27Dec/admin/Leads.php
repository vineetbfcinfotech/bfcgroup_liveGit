...
//print_r($data);
    ...
    public function get_lead_multi_b()
    {
       ...
       $data['lead_id'] = $_POST['lead_id'];
        ...
        $this->db->select('tblleads.id,tblleads.lead_author_name as author_name,tblleads.email,tblleads.phonenumber,tblleads.otherphonenumber,tblleads_create_package.*,tblleads_create_package.id as multiple_book_id');
