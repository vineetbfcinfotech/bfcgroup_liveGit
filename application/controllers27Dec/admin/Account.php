...
class Account extends Admin_controller
{
	...
	public function changePaymentStatus(){
		...
		$update = $this->account_model->changePaymentStatus($payment_id, $data);
				...
				<?php } ?>
							...
							<td>
								...
								<div class="form-group">
									...
									<select style="width: 76%;" <?php if ($data->lead_payment_status >= 1) { echo " disabled "; } ?> class="form-control payment_status" name="payment_status" data-id="<?php echo $data->id; ?>" data-author="<?php echo $data->lead_author_name; ?>" data-book="<?php echo $data->lead_booktitle; ?>" data-pcost="<?php echo $data->lead_package_cost; ?>">
								...
								if ($data->lead_first_payment_receipt != '' || $data->lead_final_payment_receipt != '') { ?>
									...
									<td>
										<div class="form-group">
											<select class="form-control payment_status" name="payment_status" data-id="<?php echo $data->id; ?>"  data-author="<?php echo $data->lead_author_name; ?>" data-book="<?php echo $data->lead_booktitle; ?>" data-remaining_final="<?php echo $remaimning; ?>">
