...
$result  = data_tables_init($aColumns, $sIndexColumn, $sTable, [], [], ['calendar_id', 'departmentid', 'email', 'hidefromclient', 'host', 'encryption', 'password', 'delete_after_import', 'imap_username']);
