                     ...
                     <div class="table-responsive">
            		    ...
            		    <table class="table dt-table table-responsive scroll-responsive tablebusie" id="pending_approval_table" cellspacing="0" width="100%" role="grid" aria-describedby="DataTables_info" style="width: 100%;">
                           ...
                           <td><?php echo $booktitle;?></td>
                				   ...
                				   <td><?php if ($row->lead_book_size==1) {
...
<script>
  ...
  $(document).on('click', '.take', function() {
      ...
      url: "<?php echo admin_url('graphic_designer/changeProjectStatus'); ?>",
      ...
      success: function(data){
          ...
          window.location.href = "<?php echo admin_url('graphic_designer/project_in_process'); ?>"
          //window.location.replace("<?php //echo admin_url('graphic_designer/project_in_process'); ?>");
