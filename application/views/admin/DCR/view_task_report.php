                        ...
                        <div class="tableData">
                            <div class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    ?>
                                        <a href="<?= base_url() ?>admin/DCR/new_export/<?= $start_date ?>/<?= $end_date ?>/<?=$staff_name_exp?>" class="btn btn-primary">Export</a>
                                    </div>
                                <div class="col-sm-8">
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <?php $staff_id = $_SESSION['staff_user_id'];
                                            ...
                                            <form method='post' action="<?= base_url() ?>admin/DCR/viewTaskReport">
                                                <?php if ((is_admin()) || $staff_id == 28 || $staff_id == 34 || $role == 92 || $role ==78 || ($staff_id==74) ) { ?>
