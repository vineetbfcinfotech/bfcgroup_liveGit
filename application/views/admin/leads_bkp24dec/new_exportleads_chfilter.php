...
<div id="wrapper" data-curpage="<?php echo $this->uri->segment(4); ?>">
  ...
  <div class="row">
                        ...
                        <!-- <a href="<?= admin_url();?>leads_order/exports_data"  class="btn btn-primary ">Export All</a> -->
                            <!-- <a href="JavaScript:Void(0);" class="btn btn-primary export_filter"> -->
                            <?php 
                             if ($search_category == '') {
                                // echo 'test'.$search_category.'hello';
                                $search_category = 'no_cat';
                            } 
                            if($start_date == ''){
                                $start_date = 'no_date';
                            }
                        ...
                        <a href="<?= admin_url();?>leads_order/new_export/<?= $search_category ?>/<?= $start_date ?>/<?= $end_date ?>/<?=$staff_name_exp?>" class="btn btn-primary">Export</a>
                        ...
                        <div class="col-md-4">
                            <form method='post' action="<?= base_url() ?>admin/leads_order/exportleads">
                                ...
                                <select multiple data-none-selected-text="Select Category" name="category_type[]" id="tasktypefilter" data-live-search="true" class="selectpicker custom_lead_filter">
                                    ...
                                    <!-- <option <?php// if (in_array(0, $search_cat)) { echo "selected"; } ?> value="0">No Category</option> -->
