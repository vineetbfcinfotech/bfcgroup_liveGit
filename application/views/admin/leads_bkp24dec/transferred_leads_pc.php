...
<div class="row">
  <div class="col-md-2">  <a href="JavaScript:Void(0);" onclick="goBack()"  class="btn btn-primary "
                      ...
                      <!--   <a href="<?= admin_url();?>Leads/exports_data"  class="btn btn-primary ">
                                ...
                                <div class="col-sm-1">
                                    <?php 
                                    $search_category = implode('-',$search_cat);
                                    if($search_category==''){
                                        $search_category = 'no_cat';
                                    }
                                    if ($start_date == '') {
                                        $start_datexp = 'no_date';
                                    }else{
                                        $start_datexp = $start_date;
                                    }
                                    if ($end_date == '') {
                                        $end_datexp = 'no_date';
                                    }else{
                                    ...
                                    $staff_name_exp = implode('-', $staff_name);
                                    ?>
                                        <a href="<?= base_url() ?>admin/Leads_order/transfered_export/<?= $search_category ?>/<?= $start_datexp ?>/<?= $end_datexp ?>/<?=$staff_name_exp?>" class="btn btn-primary">Export</a>
                                    </div>
