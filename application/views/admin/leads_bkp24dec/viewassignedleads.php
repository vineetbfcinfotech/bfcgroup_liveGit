                        ...
                        <table id="example33" class="table table-striped table-bordered" cellspacing="0" width="100%" height="50%">
                           <thead>
                              <tr>
                                 ...
                                 <th class="bold">Create package </th>
                           ...
                           <tbody class="ajax-data">
                              ...
                              <tr id='lead_id_<?= $alllead->id; ?>'>
                                 ...
                                 <td id="srNumberget">
                                    <?php // echo $ii*1; ?>   
                                    <a data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false" href="javascript:void(0)"
                                 ...
                                 <td><?php echo $ii*1; ?></td>
                                   <td ><?php  if($alllead->craete_package == NULL){ ?>
                                   <a href="<?php echo admin_url('Leads/publishing/').$alllead->id;; ?>" target="_blank" <?php if($alllead->lead_category_id == 5 || $alllead->lead_category_id == 16 || $alllead->lead_category_id == 38){ echo "style="; }else{ echo "style='pointer-events: none; color: #9cc6d9;'"; } ?> >Create Package</a>
                                   <?php }else{ ?>
                                 <a href="javascript:void(0);" data-id="<?php echo $alllead->id ?>" class="prviewdata" >Preview </a>
                              <?php } ?></td>
                                 <td> <!-- <a href="#"
                                               onclick="edit_product_catagory(this,<?= $alllead->id; ?>,'<?= $alllead->full_name; ?>','<?= $alllead->PublishedEarlier; ?>','1');return false;"
                                               data-id="<?= $alllead->id; ?>"
                                                data-publishedEarlier="<?= $alllead->lead_publishedearlier; ?>"
                                               data-name="<?= $alllead->lead_author_name; ?>"
                                               data-phone_number="<?= $alllead->phonenumber; ?>"
                                    data-srnumber="<?= $count; ?>"
                                               ...
                                               data-next_calling="<?= $alllead->next_calling; ?>"
                                               data-status="<?= $alllead->lead_category_id; ?>"
                                               data-description="<?= $alllead->description; ?>"></a> -->
                                 ...
                                 <td>
                                    ...
                                    //   $this->db->group_by("lead_id");
                                       ...
                                       echo "<span class='assignedleads2_line395'>".(current($data)->remark)."</span>";
   ...
   $('#modelClose').click(function(){
      ...
      function edit_product_catagory(invoker, id, name,publishing, phonenumber) {
          //console.log()
           ...
           $.ajax({
               url: "<?php echo base_url(); ?>admin/leads/allleadremark_model",
               method: 'POST',
               data: {
                   id: id,
                   name: name,
