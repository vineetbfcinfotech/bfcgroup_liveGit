<div class="modal-dialog <?php echo get_option('product_catagory_modal_class'); ?>">
    <div class="modal-content data">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Update Lead before</h4>
        </div>
        <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="lead_submit" name="submit" class="btn btn-info category-save-btn">Submit</button>
        ...
        <script type="text/javascript">
                ...
                console.log('leadCreationDate'+leadCreationDate);
