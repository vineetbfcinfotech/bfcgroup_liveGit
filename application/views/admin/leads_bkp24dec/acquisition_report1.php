                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <?php $staff_id = $_SESSION['staff_user_id'];
                                                $role = get_imp_role();
                                        if ((is_admin()) || $staff_id == 28 || $staff_id == 34 || $role == 92 || $role ==78 ) { ?>
...
<?php }?>
                                                ...
                                                <td><?php echo ($row->cost_of_additional_copy) * 0.25; ?></td>
                                                 ...
                                                 $sumPkgVal;
                                                 $totPkgVal;
                                                 if(is_null($row->lead_packge_discount)){?>
                                                <td><?php echo  $totPkgVal = $row->lead_packge_value + ($row->cost_of_additional_copy) * 0.25; ?></td>
                                                <?php }else{ ?>
<td><?php echo  $totPkgVal = $row->lead_lesspckg_value + ($row->cost_of_additional_copy) * 0.25; ?></td>
<?php }
 $sumPkgVal += $totPkgVal;
?>
                                            </tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2"><span class="h4">Total: </span><span class=""><?php echo $sumPkgVal; ?></span></div>
                                </div>
                            <p><?php echo $links; ?></p>
