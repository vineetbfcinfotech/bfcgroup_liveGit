                  ...
                  <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                      ...
                      <div class="form-group" app-field-wrapper="company"><label for="company" class="control-label">Company</label>
                            <select id="company" name="company[]" class="selectpicker" data-width="100%" data-none-selected-text="Nothing selected" data-live-search="true" tabindex="-98" multiple>
                                <option value=""></option>
                                <option <?php if($member->company == '1') echo "selected"; ?> value="1">BFC Capital</option>
                                <option <?php if($member->company == '2') echo "selected"; ?> value="2">BFC Infotech</option>
                                <option <?php if($member->company == '3') echo "selected"; ?> value="3">BFC Publications</option>
                            </select>  
                        </div> 
                      <?php //print_r($teamdetails);exit; ?> 
                    <?php 
                    if(isset($member)){
                    ...
                    <div class="form-group">
                        ...
                        <input required  value="<?= $member->birth_date; ?>" id="birth_date" <?php if(has_permission('staff','','edit')){ ?> name="birth_date"<?php } else { ?> disabled="true"<?php } ?> class="form-control datepicker" >
                          
                    </div>
                    
                    <div class="form-group">
                        <label for="gender" class="control-label">Date of confirmation</label>
                        <input  value="<?= $member->confirmation_date; ?>"  id="confirmation_date" <?php if(has_permission('staff','','edit')){ ?> name="confirmation_date"<?php } else { ?> disabled="true"<?php } ?> class="form-control datepicker" >
					 ...
					 <div class="form-group">
                        <label for="exit_date" class="control-label">Employee Exit Date</label>
