            ...
            <div class="col-md-7">
                <div class="panel_s">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" <?php if(has_permission('staff','','edit')){ ?> name="firstname"<?php } else { ?> disabled="true"<?php } ?>   value="<?php if(isset($member)){echo $member->firstname;} ?>">
                    </div>
                    <div class="form-group">
                        <label for="lastname" class="control-label"><?php echo _l('staff_add_edit_lastname'); ?></label>
                        <input type="text" class="form-control"  <?php if(has_permission('staff','','edit')){ ?> name="lastname"<?php } else { ?> disabled="true"<?php } ?> value="<?php if(isset($member)){echo $member->lastname;} ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number"<?php if(has_permission('staff','','edit')){ ?> name="phonenumber"<?php } else { ?> disabled="true"<?php } ?> class="form-control" value="<?php echo $member->phonenumber; ?>" id="phonenumber">
                    </div>
...
<script>
 $(function(){
   _validate_form($('#staff_profile_table'),{firstname:'required',lastname:'required',email:'required',gender:'required',marital_status:'required'});
