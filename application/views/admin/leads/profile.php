      ...
      <div class="lead-edit<?php if(isset($lead)){echo ' hide';} ?>">
         ...
         <div class="col-md-4">
            <div class="form-group form-group-select-input-source input-group-select">
                <label for="source" class="control-label"> <small class="req text-danger">* </small>Source</label>
               
                        <select id="source" name="source" class="selectpicker " data-width="100%" data-none-selected-text="Nothing selected" data-live-search="true" tabindex="-98">
                            
                            <option value="1" >Via Campaign</option>
                            <option value="8" selected>Via Reference</option>
                            <option value="6">Via QC</option>
        ...
        <!-- <div class="clearfix"></div>
         ...
         <!-- Add Product on leads By Aditya -->
         <!-- <div class="col-md-3">
            <?= render_select('product_category_id',$prod_cats,array('id',array('name','short_name')),'lead_add_edit_product_category'); ?>
         </div> -->
         <!-- <div class="col-md-3">
            <?= render_select('product_company_id',$prod_companies,array('id',array('name')),'lead_add_edit_product_company'); ?>
         </div> -->
         <!-- <div class="col-md-3">
            <?= render_select('product_scheme_type_id',$prod_schemes,array('id',array('name','short_name')),'lead_add_edit_product_schema'); ?>
         </div> -->
         <!-- <div class="col-md-3">
            <p>Soon</p>
            <?php #render_select('product_product_id',$prod_schemes,array('id',array('name','short_name')),'lead_add_edit_products'); ?>
         </div> -->
         <div class="clearfix"></div>
         <hr class="no-mtop mbot15" />
         ...
         <div class="col-md-6">
          ...
          <!--  <?php $value = (isset($lead) ? $lead->title : ''); ?>
           ...
           <?php if((isset($lead) && empty($lead->website)) || !isset($lead)){
                 ...
                 echo render_input('website','lead_website',$value, 'url');
              } else { ?>
              <div class="form-group">
               <label for="website"><?php echo _l('lead_website'); ?></label>
               <div class="input-group">
                  <input type="text" name="website" id="website" type="url" value="<?php echo $lead->website; ?>" class="form-control">
            ...
            <?php echo render_input('phonenumber','lead_add_edit_phonenumber',$value, 'number', array('pattern'=>'[0-9]{10}', 'maxlength'=>'10', 'minlength'=>'10')); ?>
         ...
         <div class="col-md-6">
          ...
          <!--  <?php
            ...
            <?php echo render_input('zip','lead_zip',$value,'number', array('pattern'=>'[0-9]{6}', 'maxlength'=>'6', 'minlength'=>'6')); ?>
            <!--<?php if(get_option('disable_language') == 0){ ?>
            <div class="form-group">
