                        ...
                        <div >
                            ...
                            <?php if (!empty($assignedleads) > 0) { ?>
                                ...
                                <table class="table dt-table scroll-responsive example11">
                                    ...
                                    <th class="bold">Contact Number1</th>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <table class="table dt-table table-bordered scroll-responsive">
                              ...
                              <?php $a=1;
                               foreach($getDataEmail as $rt)
                               {?>
                              <tr>
                                <td class="text-center"><?php echo $a; ?> </td>
                                <!--<td class="text-center"><?php //$var = explode("91",$rt['phone_number']);echo $var[1]; ?></td>-->
                                <td class="text-center"><?php echo $rt['email']; ?></td>
                                <td class="text-center" ><?php echo $rt['cnt']; ?> </td>
                               
                                <td class="text-center"><a class="btn btn-small btn-primary" href="<?php echo base_url() ?>admin/leads/view_duplicate_list_email/<?php echo $rt['email']; ?> ">View</a></td>
                ...
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            <?php //print_r(count($getData));exit;
                            if(count($getData) != 0 || count($getData_multi_n) != 0){?>
                            <table class="table dt-table table-bordered scroll-responsive">
                                <thead>
                									<tr>
                										<td class="bold text-center">Sr. No</td>
                ...
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <h3 style="color:red;">
                          Duplicate Leads based on Email(December month)
                          </h3>  
                        </div>
                        <div class="col-md-4">
                        </div>
                     ...
                     <div class="row">
                            <?php //print_r(count($getData));exit;
                            if(count($getDuplicateDatabasedOnEmail) != 0 ){?>
                            <table class="table dt-table table-bordered scroll-responsive">
                                <thead>
                                  <tr>
                                    <td class="bold text-center">Sr. No</td>
                              ...
                              <?php $a=1;
                               foreach($getDuplicateDatabasedOnEmail as $rt)
                               {?>
                              <tr>
                                <td class="text-center"><?php echo $a; ?> </td>
                                <!--<td class="text-center"><?php //$var = explode("91",$rt['phone_number']);echo $var[1]; ?></td>-->
        ...
        <div class="col-md-12">
            <div class="panel_s">
                <div class="panel-body">
                    ...
                    // $this->db->orwhere('assigned',null);
                    $comp_lead = $this->db->select('lead_author_msstatus,assigned')
                    ->where('assigned',0)
                    ->where('lead_author_msstatus','completed')
                    ->get('tblleads')->result();
                    $comp_lead = count($comp_lead);

                    $inp_lead = $this->db->select('lead_author_msstatus,assigned')
                    ->where('assigned',0)
                    ->where('lead_author_msstatus','in_process')
                    ->get('tblleads')->result();
                    $inp_lead = count($inp_lead);
                    
                    $na_lead = $this->db->select('lead_author_msstatus,assigned')
                    ->where('assigned',0)
                    ->where('lead_author_msstatus','')
                    ->get('tblleads')->result();
                    $na_lead = count($na_lead);
                    ?>

                    <div class="row ">
                        <div class="col-md-4 ">
                            
                            <label class="h4 col-form-label">Completed:</label>
                            <label class=" h4 form-text"><?= $comp_lead ?> </label>
                        </div>
                        <div class="col-md-4 ">
                            
                            <label class="h4 col-form-label">In Process:</label>
                            <label class="h4 h4form-text"><?= $inp_lead ?> </label>
                        </div>
                        <div class="col-md-4 ">
                            <label class="h4 col-form-label">N/A:</label>
                            <label class="h4 form-text"><?= $na_lead ?> </label>
                        </div>
