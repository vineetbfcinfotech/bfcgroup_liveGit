            ...
            <div class="horizontal-tabs">
               ...
               <div class="tab-content">
                  ...
                  <div role="tabpanel" class="tab-pane" id="home_my_reminders">
					 ...
					 <table id="" class="table dt-table scroll-responsive" style="width:100%">
					   <thead>
						  <tr role="row">
							 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1">Related to</th>
							 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1">Description</th>
							 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1">Date</th>
						  </tr>
					   </thead>
					   <tbody></tbody>
					</table>
                     ...
                     <?php //render_datatable(array( _l( 'reminder_related'),_l('reminder_description'), _l( 'reminder_date'),       ), 'my-reminders'); ?>
					 
                  </div>
                  <?php if(is_staff_member()){ ?>
                  <div role="tabpanel" class="tab-pane" id="home_announcements">
                     <?php if(is_admin()){ ?>
                     <a href="<?php echo admin_url('announcements'); ?>" class="mbot20 inline-block pull-left"><?php echo _l('home_widget_view_all'); ?></a>
					 <a href="<?php echo admin_url('announcements/announcement'); ?>" class="mbot20 inline-block pull-right">Add New Announcement</a>
                     <div class="clearfix"></div>
                     <?php } ?>
					 ...
					 <table id="example" class="table dt-table scroll-responsive" style="width:100%">
						<thead>
						  <tr>
							 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1">Sr. No.</th>
							 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1">Subject</th>
							 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1">Date</th>
							 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1">Announcement by</th>
						  </tr>
					   </thead>
						<tbody>
                     ...
                     <?php //render_datatable(array(_l('announcement_name'),_l('announcement_date_list'),_l('announcement_userid')),'announcements'); ?>
                  </div>
                  <?php } ?>
                  <?php if(is_admin()){ ?>
