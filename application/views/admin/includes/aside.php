...
<style>
#side-menu li .nav-second-level li.sub-menu-item-team_name {
    background-color: #0d64d6 !important;
...
#side-menu li .nav-second-level li.sub-menu-item-team_name a {
...
#side-menu li .nav-second-level li.sub-menu-item-team_name > a:hover {
    padding: 5px 12px 6px 14px;
    color: #f5f5f5;
    text-transform: none;
    font-size: 15px;
...
#side-menu li .nav-second-level li.sub-menu-item-meetings_by_trm a {
...
#side-menu li .nav-second-level li.sub-menu-item-meetings_by_trm {
  ...
  #side-menu li .nav-second-level li.sub-menu-item-meetings_by_trm.active > a{
...
#side-menu li .nav-second-level li.sub-menu-item-meetings_by_trm > a:hover{
    /*padding: 7px 10px 7px 45px;*/
    color: #fff !important;
        padding: 2px 24px 2px -4px !important;
    border-radius: 19px;
...
<script>
    $(document).ready(function(){
      $("#widget-calendar").hide();
        $("#side-menu li .nav-second-level li.sub-menu-item-team_name a").removeAttr("href");
        $("#side-menu li .nav-second-level li.sub-menu-item-meetings_by_trm a").removeAttr("href");
    })
</script>
