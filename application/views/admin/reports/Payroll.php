...
class Payroll extends Admin_controller
{
    ...
    public function editempsal()
    {
        if($this->input->post())
            ...
            'overtime_salary' => $overtime_salary, 'house_rent_allowance' => $house_rent_allowance, 'special_allowance' => $special_allowance, 'conveyance_allowance' => $conveyance_allowance, 'provident_fund' => $provident_fund, 'tax_deduction' => $tax_deduction, 'net_salary' => $net_salary,'qualifying_ctc' => $q_ctc,'baby_shitiing_loss' => $baby_shitiing_loss,'last_finacial_year' => $last_fincial_year,'start_finacial_year' => $start_finacial_year);
           
           
            //print_r($resultData1); exit();
