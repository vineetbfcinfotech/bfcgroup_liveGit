         ...
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  <h2><?php echo _l('upload_scheme'); ?></h2>
                  <hr class="hr-panel-heading">
                  <?php if(has_permission('manage_product_basket','','create')){ ?>
                  <div class="_buttons">
                     <button href="" class="btn btn-info pull-left display-block" data-toggle="modal" data-target="#import_modal" ><?php echo _l('upload_scheme'); ?></button>
                  </div>
                  <?php } ?>
...
$(document).ready(function(){
	$('#import_csv').on('submit', function(event){
		...
		$.ajax({
			url: "<?php echo admin_url(); ?>development/import_scheme_data",
			method: "POST",
...
$.ajax({
	url: "<?php echo admin_url(); ?>development/getImportedSchemeData",
	method: "POST",
	//data: new FormData(this),
	success:function(data)
	{
