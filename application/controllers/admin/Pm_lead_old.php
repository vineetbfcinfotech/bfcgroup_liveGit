    ...
    private $not_importable_leads_fields;
        ...
        public function sendmail(){
          $staff_id = $_SESSION['staff_user_id'];
            ...
            $message .= "<p>Please allow me to start by introducing myself, I am Shivangi and I have been nominated by BFC Publications to guide your project, due to which, we shall remain in constant touch over the next few weeks.</p>";
            ...
            $message .="<a href=". base_url("admin/Asf_controller/index/". $packageData->email).">ASF Form</a>";
            $message .= "<p>Please find below  the link of the Payment. Feel free to contact me if you have any queries</p>";
         
            $message .=" To Payment <a  href='https://authordashboard.bfcpublications.com/paymentop' target='_blank'>Click  Here</a>";
        ...
        public function pip($value=''){
         ...
         $data['gourav_remaing_pages']= $this->common_func_for_remaining_p(82, 'fe');
          ...
          $data['varuna_remaing_pages']= $this->common_func_for_remaining_p(80,'pr');
          ...
          public function common_func_for_remaining_p($id='', $type='')
        {
            ...
            // print_r($get_all_data);
        	 if ($type == 'gd') {
        	 	$get_all_data = $this->db->get_where('tblleads',array('lead_asf_assign_gd'=>$id , 'project_status !='=>15))->result();
        ...
        public function cover_assign_work($value='')
        {
            ...
            if ($rework_or_completed < 4) {
            	  if ($rework_or_completed == 2) {
              $data = array(
