...
<aside id="menu" class="sidebar">
   <ul class="nav metis-menu MenuA-13" id="side-menu">
      ...
      <li class="quick-links  menuAA-18">
      ...
      <li class="menu-item-<?php  echo $item->id; ?> menuDD159">
         ...
         <ul class="nav nav-second-level collapse menuBB-167" aria-expanded="false">
...
<?php
        $men_nitesh_hide=array('av_leadsreff','av_leads2','av_leads4','av_leads5','av_leads6','av_leads7','av_leads8','import_leads','export_leads');
        
        $men_admin_hide=array('av_leadsreff','duplicate_entry','av_leads1','av_leads2','av_leads3','av_leads5','av_leads6','av_leads7','av_leads8','MenuCC219','import_leads','export_leads');
        //$men_admin_hide=array('duplicate_entry');
        
       
        $staff_array_ids=array('54','53','38','68','69','70');
        
        //$men_staff_array_hide=array('av_leads1','av_leads2','av_leads3','av_leads5','av_leads6','av_leads7','av_leads8');
        $men_staff_array_hide=array('av_leads1','av_leads2','av_leads3','av_leads5');
          //$men_staff_array_hide=array();
        $men_nitesh_hide1 = array();
        $der='';
    
    if($_SESSION['staff_user_id']=='61'){
        
     if(in_array($submenu->id,$men_nitesh_hide)){
     ...
     /*if($_SESSION['staff_user_id']=='68'){
        
     if(in_array($submenu->id,$men_nitesh_hide1)){
     ...
     if(in_array($submenu->id,$men_admin_hide)){
 ...
 if(in_array($_SESSION['staff_user_id'],$staff_array_ids)){
        
     if(in_array($submenu->id,$men_staff_array_hide)){
    ...
    ?>
            ...
            <li <?php echo $der;  ?> class="sub-menu-item-<?php echo $submenu->id; ?>  MenuCC219"><a href="<?php echo $url; ?>">
