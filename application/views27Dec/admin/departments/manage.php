            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
					...
					<table class="table dt-table scroll-responsive">
						...
						foreach($email_exist_as_staff as $department){  ?>
							<tr>
								<td><?php echo $i; ?></td>
...
<div class="modal fade" id="department" tabindex="-1" role="dialog">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
						...
						<label for="name" class="control-label"> <small class="req text-danger">* </small>Choose Company</label>
                        ...
                        <?php render_input('calendar_id','department_calendar_id'); ?>
    ...
    <script>
        $(function(){
           initDataTable('.table-departments', window.location.href, [2], [2]);
	...
	$(document).ready(function(){
	  $("#company").change(function(){
		...
		$('.table').hide(); */
		$.ajax({
           url: "<?php echo base_url('admin/departments/getdepartment'); ?>",
           type: 'POST',
