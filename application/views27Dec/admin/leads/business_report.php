            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <h3>
                                <!-- <a href="<? //= base_url('admin/leads/business_mobilization'); 
                                                ?>" class="btn btn-alert"
                                   onclick="">
                                    Back</a> -->
                                <a href="javascript:void(0);" class="btn btn-alert" onclick="goBack()">
                                    Back</a>
                        </div>
                        <select id="filterrm" multiple data-none-selected-text="Filter By RM" data-live-search="true" class="selectpicker custom_lead_filter">
                        ...
                        <div class="dropdown bootstrap-select show-tick">
                            <input type="text" id="transctiondatestart" autocomplete="false" name="transctiondatestart" placeholder="Period From" class="form-control datepicker custom_lead_filter" />

                        </div>
                        <div class="dropdown bootstrap-select show-tick">
                            <input type="text" id="transctiondateend" autocomplete="false" name="transctiondateend" placeholder="Period To" class="form-control datepicker custom_lead_filter" />

                        </div>

                        <select id="filterstatus" multiple data-none-selected-text="Filter By Status" data-live-search="true" class="selectpicker custom_lead_filter">
                        ...
                        <select id="filterprotype" multiple data-none-selected-text="Filter By Product Type" data-live-search="true" class="selectpicker custom_lead_filter">
...
<script>
    $(document).ready(function() {
        $('.custom_lead_filter').change(function() {

            $('#unsetallfilter').focus();
            ...
            } else if (transctiondatestart && !transctiondateend) {
...
<script>
    $("select.business_status_list").change(function() {
        ...
        if (($('#transctiondateend').val() != null) || (sessionStorage.getItem("transctiondateend") != null) || ($output2 != undefined) || ($('#transctiondateend').val() != undefined)) {
