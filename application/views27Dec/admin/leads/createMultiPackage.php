                            ...
                            <div class="row">
                                                    ...
                                                    foreach ($result as $data) {    ?>
                                                        <div class="row-add<?= $i; ?>" data-id="<?= $i; ?>">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control services" id="services<?= $i; ?>" class="services" name="services[]" style="width: 100%; <?php if ($leadData->lead_package_detail == 1) { ?>display:none; <?php } else { ?>display:block;<?php } ?>">
                                                                            ...
                                                                            $this->db->where('a.book_type', $leadData->book_format);
                                                            ...
                                                            <div class="sub_services_data_<?= $i; ?> sub_services<?= $i; ?>   subservices">
                                                                ...
                                                                $subservices = $this->leads_model->sub_servicesedit($data->id, $sub_services, $leadData->book_format);
                                                                 if ($subservices[0]->subservice_name == 'Format Editing'|| $subservices[1]->subservice_name =='Proofreading') { ?>
                                                                        ...
                                                                        <input type="text" disabled id="increment" name="increment" onkeyup='myFunctiondatacomplimentry("<?= $data->id; ?>","<?=$data->cost ?>");'  class="form-control" value="<?= $leadData->lead_book_pages;?>" >
                                                                        </div>
                                                                        </div>
                                                                   <?php }
                                                                foreach ($subservices as $subservice) {
                                                                    if ($subservice->subservice_name == 'Complimentary Author Copies') { ?>
                                                                        ...
                                                                        <input type="text" disabled id="complimentry_copies" name="complimentry_copies" onkeyup='myFunctiondatacomplimentry("<?= $data->id; ?>","<?=$data->cost ?>");'  class="form-control" value="<?= $leadData->complimentry_copies;?>" >
                                                                        </div>
                                                                        </div>
                                                                   <?php }
                                                                 ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" app-field-wrapper="total_amount">
                                       ...
                                       <?php if (($leadData->lead_package_detail == 3) && ($leadData->last_lead_status > 0)) {?>
                                            <div class="form-group cost_additional_copy" app-field-wrapper="" >
                                        <label for="" class="control-label">Cost of additional copy</label>
                                        <input type="text" id="cost_of_additional" name="cost_of_additional" class="form-control" placeholder="0" value="<?php echo $leadData->website; ?>" readonly>
                                      ...
                                      <div class="form-group additional_gross_amt" app-field-wrapper="" >
                                        ...
                                        <input type="text" id="additional_gross_amount" name="additional_gross_amount" class="form-control" placeholder="0" value="<?= $leadData->junk?>" readonly>
                                    </div>
                                       <?php }else{ ?>
                                    ...
                                    <div class="modal-body preview-package">
                                        ...
                                        <table class="table table-bordered table-condensed">
                                            ...
                                            <tr  class="final_hide_default">
                                                ...
                                                <tr id="showing_additional_cost" style="display: none">
                                                    <td>
                                                        <h6>
                                                            <strong>
                                                ...
                                                <tr id="showing_gross_additional_cost" style="display: none">
                                                    <td>
                                                        <h6>
                                                            <strong>
     ...
     <script>
        $(window).load(function() {
            ...
            <?php if ($leadData->lead_package_detail) { ?>
                ...
                var additional_gross_amount = '<?= $leadData->junk; ?>';
                var cost_of_additional = '<?= $leadData->website; ?>';
