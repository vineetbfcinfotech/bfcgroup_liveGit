                ...
                <div class="panel_s">
                    ...
                    <table class="table dt-table scroll-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="#" onclick="edit_source(this,<?php echo $source['id']; ?>); return false" data-name="<?php echo ucfirst($source['name']); ?>"><?php echo ucfirst($source['name']); ?></a><br />
                                    <span class="text-muted">
                                        <?php echo _l('leads_table_total',total_rows('tblleads',array('source'=>$source['id']))); ?>
                                    </span>
                                </td>
                                <td>
                                    <a href="#" onclick="edit_source(this,<?php echo $source['id']; ?>); return false" data-name="<?php echo ucfirst($source['name']); ?>" class="btn btn-default btn-icon"><i class="fa fa-pencil-square-o"></i></a>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_input(ucfirst('name'),'leads_source_add_edit_name'); ?>
                    </div>
                </div>
            </div>
