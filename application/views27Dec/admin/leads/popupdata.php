					 ...
					 if ($result->subservice_name == 'Number of Pages Allowed') {
                            ...
                            $number_page =  $package_data->lead_book_pages;
                               ...
                               $number_page =  $package_data->lead_book_pages;
                                // htmldata += "<li>"+subServicessArray[k]+" ("+number_page+")</li>";
                                  echo "<li>".$result->subservice_name ."(".$number_page.") </li>";
                            }else if ($result->subservice_name == 'Proofreading') {
                               $number_page =  $package_data->lead_book_pages;
                                  echo "<li>".$result->subservice_name ."(".$number_page.") </li>";
                            }
...
<table class="table table-bordered table-condensed">
  ...
  <tbody>
	 ...
	 <?php if(($package_data->cost_of_additional_copy > 0) && ($package_data->gross_amt > 0)){ ?>
	 	 <tr>
...
<td class="emaiInfo1" style="display:none;">
   ...
   <span >shivangiyadav@bfcpublications.com</span>
      ...
      <div class="modal-footer">
          ...
          <a href="<?php echo admin_url('Leads/publishing/'.$package_data->id);?>" class="btn btn-success" >Edit</a>

	

          <a class="btn btn-success" href="<?php echo admin_url('Leads/sendmail/'.$package_data->id);?>" tooltip='test'>Send mail</a>
    
         <a class="btn btn-success emaiInfoshow1" >Show Email CC info</a>

      </div>
      <script>
          $(document).ready(function(){
              $('.emaiInfoshow1').click(function(){
				//   alert('test')
                 $('.emaiInfo1').show();    
              })
           //
