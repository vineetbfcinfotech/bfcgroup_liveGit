                        ...
                        <div class="row aquired_data" style="<?php if($categoryStatus == "39"){ ?>display: block;<?php }else{ ?> display: none; <?php } ?>">
                               <div class="col-md-6">
                                  <div class="form-group" app-field-wrapper="package_cost">
                                     ...
                                     <input <?php if($lead_status ==1 || $lead_status==2 || $lead_status==3 ){ echo "disabled"; }?> type="text" id="package_cost" name="package_cost" class="form-control" value="<?php echo $all_lead_data->lead_packg_totalamount; ?>" disabled>
                                  </div>
                               </div>
                               <div class="col-md-6">
                                  <div class="form-group" app-field-wrapper="booking_amount">
                                      <label for="booking_amount" class="control-label">Booking amount</label>
                                      <input <?php if($lead_status ==1 || $lead_status==2 || $lead_status==3 ){ echo "disabled"; }?> type="text" id="booking_amount" name="booking_amount" class="form-control"  value="<?php echo $all_lead_data->booking_amount; ?>" >
                                  </div>
                               </div>
                               <div class="col-md-6">
                                  <div class="form-group" app-field-wrapper="finstallment">
                                      <label for="finstallment" class="control-label">First installment</label>
                                      <input <?php if($lead_status ==1 || $lead_status==2 || $lead_status==3 ){ echo "disabled"; }?> type="text" id="finstallment" name="finstallment" class="form-control" disabled value="<?php echo $all_lead_data->first_installment; ?>" >
                                  </div>
                               </div>
                               <div class="col-md-6">
                                  <div class="form-group" app-field-wrapper="final_payment">
                                      <label for="final_payment" class="control-label">Final payment</label>
                                      <input <?php if($lead_status ==1 || $lead_status==2 || $lead_status==3 ){ echo "disabled"; }?> type="text" id="final_payment" name="final_payment" class="form-control" disabled value="<?php echo $all_lead_data->final_payment; ?>" >
                                  </div>
                               </div>
                               <div class="col-md-6">
