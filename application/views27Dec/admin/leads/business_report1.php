         ...
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <div class="tableData">
                     <table id="table_id" class="display table dt-table scroll-responsive">
                        <thead>
                           <tr>
                              <th>Investor Type</th>
						...
						<tbody>
							<?php foreach($allBusinessData as $bdata){ ?>
							<tr>
								<td><?php echo $bdata->investor_name; ?></td>
								<td><?php echo $bdata->transaction_date; ?></td>
								<td><?php echo $bdata->pro_type; ?></td>
								<td><?php echo $bdata->company_name; ?></td>
								<td><?php echo $bdata->folio_number; ?></td>
								<td><?php echo $bdata->tenure; ?></td>
								<td><?php echo $bdata->product_name; ?></td>
								<td><?php echo $bdata->transaction_type; ?></td>
								<td><?php echo $bdata->transaction_amount; ?></td>
								<td><?php echo $bdata->credit_rate; ?></td>
								<td><?php echo $bdata->gross_credit_amount; ?></td>
								<td><?php echo $bdata->gst_rate; ?></td>
								<td><?php echo $bdata->post_gst_credit; ?></td>
								<td><?php echo $bdata->tds_rate; ?></td>
								<td><?php echo $bdata->net_credit; ?></td>
								<td><?php echo $bdata->staff_res; ?></td>
