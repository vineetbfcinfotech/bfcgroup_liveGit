                  ...
                  <div class="_buttons">
                    <a href="<?= admin_url('products/schemes') ?>" class="btn mright5 btn-info pull-left display-block">
                     <?php echo _l('add_new_product'); ?>
                      ...
                      <a href="products/import_schemes"  class="btn mright5  pull-left display-block btn-success">
                  ...
                  <hr class="hr-panel-heading" />
                      ...
                      <table  id="schemetable" class="table dt-table scroll-responsive">
                        <thead>
                          ...
                          <th><?php echo _l('product_scheme_types'); ?></th>
                          <th><?php echo _l('product_dt_credit_rate_lum'); ?></th>
                          <th><?php echo _l('product_dt_credit_rate_sip'); ?></th>
