...
<body  style="text-align: justify;">
  ...
  <img src="uploads/company/bfc_logo.jpg">
</div>

  <h2>Book Publishing and Distribution Agreement </h2>
  <p > This agreement is entered into between <span class="font_use"><?php echo $author_name; ?></span>  of the address <?php echo $address; ?>, <?php echo $city; ?>, <?php echo $state; ?>, <?php echo $zip; ?>,  aged about <?php echo $dob; ?> as of <?php echo $lead_booking_amount_date; ?> , hereafter to be referred to as the “Author”, and BFC Publications Private Limited, having its office at CP-61, Viraj Khand, Gomti Nagar, Lucknow - 226010, to be referred to as “BFC Publications” from here on. </p>
